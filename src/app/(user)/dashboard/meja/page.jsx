...
const PageUser = () => {
	...
	return (
		<div className="w-full">
			<h1 className="font-bold text-2xl">Dashboard Meja</h1>
			<div className="flex items-center py-4 gap-2">
				<Input
					placeholder="Filter emails..."
					value={table.getColumn("nomor_meja")?.getFilterValue() ?? ""}
					onChange={(event) =>
						table.getColumn("nomor_meja")?.setFilterValue(event.target.value)
					}
					className="max-w-sm"
				/>
