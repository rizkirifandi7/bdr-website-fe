...
const useFcmToken = () => {
	...
	const [notifications, setNotifications] = useState([]); // State to store the notifications.
	...
	return { token, notificationPermissionStatus, notifications }; // Return the token and permission status.
};
